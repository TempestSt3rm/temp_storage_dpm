...
class Robot:
    ...
    def do_math_on_angle(self,blockAngle):
        ...
        if blockAngle >= 0:
            ...
            x_f = math.cos(blockAngle)* (15)
            y_f = math.sin(blockAngle) * (15)
            if (y_f > 5.5):             
    ...
    def spray_search(self):
        ...
        while True:
            ...
            if thing == "p":
                print("found poop")
            if thing == "wall" or thing == "left" or thing == "right":
                self.go_home()
                break
