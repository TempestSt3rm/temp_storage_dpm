...
class Robot:
    ...
    def sweepAndDetect(self):
        ...
        self.motor_sweep.set_dps(0)
        angle,identity = self.has_cubes_in_range(self.Color_Readings,self.Ang_Readings)
        #21,p  or 
        print("angle detected first sweep " + str(angle) + " identity: " + identity)
        ...
        angle,identity = self.has_cubes_in_range(self.Color_Readings,self.Ang_Readings)
        #21,p  or 
        print("angle detected second sweep " + str(angle) + " identity: " + identity)
