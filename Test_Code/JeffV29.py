...
class Robot:
    ...
    def consolidate_directions(self):
...
if __name__ == "__main__":
    ...
    try:
        for i in angs:
            if i == 0:
                robot.straight_search()
            else:
                sleep(1)
                robot.dumb_forward(3)
                robot.rotate_robot("r",i)
                robot.movement_queue.pop()
                robot.movement_queue.pop()
                robot.spray_search()
